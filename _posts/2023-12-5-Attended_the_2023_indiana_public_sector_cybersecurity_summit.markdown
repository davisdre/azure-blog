...
Moderated by Mike White (Deputy Chief Technology Officer, IN.gov and Payment Processing Programs, Office of Technology, State of Indiana), the session on cloud readiness featured insights from Elaine Kan (Chief Technology Officer, State Personnel Department, State of Indiana), Ryan Parthasarathy (Managing Director, Accenture), and Sean Totten (Chief Security Officer, Information Technology, City of Fishers). The discussion underscored the significance of understanding the shared responsibility model, data types, proper tagging, and the appeal of cloud solutions for their resource efficiency. The inevitability of faster updates in the cloud compared to on-premises solutions was discussed, along with the prevalence of hybrid cloud applications and the importance of cost considerations.
